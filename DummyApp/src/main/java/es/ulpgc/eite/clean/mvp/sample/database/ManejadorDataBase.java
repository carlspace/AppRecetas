    ...
    public void initBaseDeDatos(){
        ...
        if(realm.isEmpty()) {
            ...
            addTipoComida("Ensaladas");
                int idTipoComida=1;
                        ...
                        String ingredientes ="1 Bolsa de Cogollos de Tudela\n" +
                                ...
                                " 1 Chorro de Vinagre\n";
                        addPlato(nombrePlato, receta, idTipoComida, ingredientes, "ensalada_cogollos_con_tudela_y_anchoas.jpg", "gr3LiqwIVx4",true);
                        ...
                        addPlato(nombrePlato, receta, idTipoComida,ingredientes, "ensalada_pimientos_asados_con_bonito.jpg", "gh5sdgbvpJU",true);
                        ...
                        addPlato(nombrePlato, receta, idTipoComida,ingredientes, "ensalada_buey_mar.jpg", "81Jo4YGuRCY",true);
            ...
            ingredientes ="4 huevos\n" +
                    ...
                    "Sal\n" +
                    "Perejil\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "sopa_sopa_castellana.jpg", "JHS2yw5_aFE",true);
            ...
            ingredientes ="1.200 gr de tomate pera\n" +
                    ...
                    "Vinagre\n" +
                    "Sal\n";
            addPlato(nombrePlato, receta, idTipoComida, ingredientes, "sopa_gazpacho.jpg", "7TrCI6mLT3E",true);
            ...
            ingredientes ="1 kg de tomate\n" +
                    ...
                    "Aceite de oliva virgen extra\n" +
                    "Sal\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "sopa_salmorejo.jpg", "_mb2N9apN2A",true);
            ...
            ingredientes ="800 gr de solomillo de ternera\n" +
                    ...
                    "50 ml de leche\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "carne_solomillo_wellington.jpg", "bNDh4QWbPC4",true);
            ...
            ingredientes ="1 rabo de vacuno\n" +
                    ...
                    "2 hojas de laurel\n" +
                    "1 rama de tomillo\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "carne_rabo_de_toro.jpg", "rGmXY2fy1Ow",true);
            ...
            ingredientes ="2 rodajas de salmón\n" +
                    ...
                    "Pimienta\n" +
                    "Perejil\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "pescado_salmon_encebollado.jpg", "ZnCb9p0R0-Y",true);
            ...
            ingredientes ="1 kg de anchoas\n" +
                    ...
                    "Sal\n" +
                    "Perejil\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "pescado_boquerones_en_vinagre.jpg", "cBxe7SsExEc",true);
            //Plato  (id=12)
            ...
            ingredientes ="1/2 kg de cazón\n" +
                    ...
                    "2 hojas de laurel\n" +
                    "Perejil\n";
            addPlato(nombrePlato, receta, idTipoComida,ingredientes, "pescado_cazon_en_adobo.jpg", "rQi-DEEiEss",true);
        }
        }
}
